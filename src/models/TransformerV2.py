...
class TransformerV2(nn.Module):
    ...
    def forward(self, org_time_x, miss_simulator):
        ...
        for loc in self.locations:
            ...
            for mod in self.modalities:
                ...
                loc_mod_freq_input = torch.permute(proc_freq_x[loc][mod], [0, 2, 3, 1])
                ...
                org_loc_mod_features[loc].append(loc_mod_feature)
    ...
    def classification_forward(self, loc_mod_features, miss_simulator):
        ...
        Args:
            loc_mod_features (_type_): dict of {loc: loc_features with shape [b * i, int(s / stride), mods, c]}
